function createBuildingDialog(field) {
    ...
    //close button
    closeButtonADDFUN(dialog)
    dialogContainer.appendChild(dialog)
}

function closeButtonADDFUN(dialog) {
...
// data-trade="${trade}" data-tradeBuilding="${building}"
        ...
        for (const button of buttons) {
            ...
            button.addEventListener("click", () => {
                ...
                for (let i = 0; i < resourcesArray.length; i++) {
                    ...
                    console.log("Required Amoubt: ", requiredAmount, "Choosed Quantity: ",Number(quantity));
